...
val CatalogEntries = listOf(
    ...
    CatalogEntry("chip-sort-filter", "Sort and filter chips", listOf("sort field and order", "filters selected and unselected", "removable source filters", "read-only info", "disabled")) {
        ChipBoard(it)
    },
