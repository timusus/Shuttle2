...
public class ColorHelper {
    ...
    public int[] ensureColors(Context context, boolean hasForegroundColor, int backgroundColor, int foregroundColor) {
        ...
        return new int[] {primaryTextColor, secondaryTextColor};
    }
}