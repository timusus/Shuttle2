...
constructor(
    ...
    suspend fun getChildren(mediaId: String): List<MediaBrowserCompat.MediaItem> = withContext(Dispatchers.IO) {
    ...
    private fun AlbumArtist.toMediaItem(parentMediaId: String): MediaBrowserCompat.MediaItem = MediaBrowserCompat.MediaItem(
        MediaDescriptionCompat.Builder()
    ...
    private fun Playlist.toMediaItem(parentMediaId: String): MediaBrowserCompat.MediaItem = MediaBrowserCompat.MediaItem(
        MediaDescriptionCompat.Builder()
            .setTitle(name)
    ...
    private fun Album.toMediaItem(parentMediaId: String): MediaBrowserCompat.MediaItem = MediaBrowserCompat.MediaItem(
        MediaDescriptionCompat.Builder()
            .setTitle(name)
    ...
    private fun Song.toMediaItem(parentMediaId: String): MediaBrowserCompat.MediaItem = MediaBrowserCompat.MediaItem(
        MediaDescriptionCompat.Builder()
            .setTitle(name)
