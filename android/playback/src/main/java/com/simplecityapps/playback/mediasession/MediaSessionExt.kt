...
fun QueueManager.RepeatMode.toRepeatMode(): Int = when (this) {
...
fun Int.toShuffleMode(): QueueManager.ShuffleMode = when (this) {
...
fun QueueManager.ShuffleMode.toShuffleMode(): Int = when (this) {
