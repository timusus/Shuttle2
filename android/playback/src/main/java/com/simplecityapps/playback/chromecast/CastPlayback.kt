...
class CastPlayback(
    ...
    override suspend fun load(
        ...
        metadata.putString(MediaMetadata.KEY_ARTIST, current.friendlyArtistName ?: context.getString(com.simplecityapps.core.R.string.unknown))
        metadata.putString(MediaMetadata.KEY_ALBUM_TITLE, current.album ?: context.getString(com.simplecityapps.core.R.string.unknown))
        metadata.putString(MediaMetadata.KEY_TITLE, current.name ?: context.getString(com.simplecityapps.core.R.string.unknown))
