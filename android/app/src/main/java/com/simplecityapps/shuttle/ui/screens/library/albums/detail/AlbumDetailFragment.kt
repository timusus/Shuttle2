...
class AlbumDetailFragment :
    ...
    override fun onViewCreated(
        ...
        imageLoader.loadArtwork(
            ...
            listOf(
                ArtworkImageLoader.Options.Priority.Max,
                ArtworkImageLoader.Options.Placeholder(ResourcesCompat.getDrawable(resources, com.simplecityapps.core.R.drawable.ic_placeholder_album, requireContext().theme)!!)
            )
        )
