...
class WidgetPreferenceFragment : PreferenceFragmentCompat() {
    ...
    override fun onViewCreated(
        ...
        preferenceScreen.findPreference<SeekBarPreference>("widget_background_opacity")?.setOnPreferenceChangeListener { _, newValue ->
            widgetManager.onBackgroundOpacityChanged(newValue as Int)
            true
        }
    }
}
