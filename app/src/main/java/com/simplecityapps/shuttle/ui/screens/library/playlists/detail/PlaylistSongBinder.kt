...
open class PlaylistSongBinder(
    ...
    interface Listener {
        fun onPlaylistSongClicked(index: Int, playlistSong: PlaylistSong)
        fun onPlaylistSongLongClicked(holder: ViewHolder, playlistSong: PlaylistSong) {}
    ...
    override fun areContentsTheSame(other: Any): Boolean {
        return other is PlaylistSongBinder
                ...
                && playlistSong.song.year == other.playlistSong.song.year
