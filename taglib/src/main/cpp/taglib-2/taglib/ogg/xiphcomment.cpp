...
unsigned int Ogg::XiphComment::trackTotal() const
{
  if(!d->fieldListMap["TRACKTOTAL"].isEmpty())
    return d->fieldListMap["TRACKTOTAL"].front().toInt();
  return 0;
}

String Ogg::XiphComment::trackTot() const
{
  return String();
}
