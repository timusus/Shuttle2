...
# dropped and S2 stays paused). The play goes through the debug receiver: a media key dispatched
# during a call goes to Telecom's global-priority session, not S2's.
