...
interface PlaylistListContract {
    ...
    interface View {
        fun setPlaylists(playlists: List<com.simplecityapps.shuttle.model.Playlist>, smartPlaylists: List<com.simplecityapps.shuttle.model.SmartPlaylist>)
    ...
    interface Presenter : BaseContract.Presenter<View> {
        ...
        fun rename(playlist: com.simplecityapps.shuttle.model.Playlist, name: String)
    }
}
...
class PlaylistListPresenter @Inject constructor(
    ...
    override fun rename(playlist: com.simplecityapps.shuttle.model.Playlist, name: String) {
        launch {
