...
interface ScannerContract {
    ...
    interface View {
        ...
        fun setSongImportProgress(providerType: MediaProviderType, progress: Progress?, message: String)
        fun setSongImportComplete(providerType: MediaProviderType)
        fun setSongImportFailed(providerType: MediaProviderType, message: String?)
        fun setPlaylistImportProgress(providerType: MediaProviderType, progress: Progress?, message: String)
        fun setPlaylistImportComplete(providerType: MediaProviderType)
        fun setPlaylistImportFailed(providerType: MediaProviderType, message: String?)
...
class ScannerPresenter @AssistedInject constructor(
    ...
    private val listener = object : MediaImporter.Listener {
        ...
        override fun onPlaylistImportProgress(providerType: MediaProviderType, message: String, progress: Progress?) {
