...
fun MediaProviderType.title(context: Context): String {
    return when (this) {
...
fun MediaProviderType.description(context: Context): String {
    return when (this) {
...
@DrawableRes
fun MediaProviderType.iconResId(): Int {
    return when (this) {
